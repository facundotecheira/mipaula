...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (surpriseBtn) {
        surpriseBtn.addEventListener('click', function() {
            ...
            this.innerHTML = '<i class="fas fa-heart"></i> ¡Te amo con todo mi corazón!';
    ...
    if (galleryContainer) {
        ...
        for (let i = 1; i <= photoCount; i++) {
            ...
            img.onerror = function() {
                ...
                this.src = 'https://images.unsplash.com/photo-1518568814500-bf0f8d125f46?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80';
            };
